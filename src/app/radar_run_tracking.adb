         ...
         for I in Trk.Tracks'Range loop
            if Trk.Tracks (I).Active and then Trk.Tracks (I).Confirmed then
               ...
               begin
                  ...
                  Put (Out_F, ",x:");   Put_Float (Out_F, Tk.Pos.X);
                  Put (Out_F, ",y:");   Put_Float (Out_F, Tk.Pos.Y);
                  Put (Out_F, ",z:");   Put_Float (Out_F, Tk.Pos.Z);
                  Put (Out_F, ",vx:");  Put_Float (Out_F, Tk.Velocity.X);
                  Put (Out_F, ",vy:");  Put_Float (Out_F, Tk.Velocity.Y);
                  Put (Out_F, ",vz:");  Put_Float (Out_F, Tk.Velocity.Z);
                  Put (Out_F, "},");
               end;
            end if;
         end loop;
